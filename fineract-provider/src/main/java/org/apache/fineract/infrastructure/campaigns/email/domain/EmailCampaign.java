...
public class EmailCampaign extends AbstractPersistableCustom<Long> {
	...
	public Map<String,Object> update(JsonCommand command){
		...
		if (command.isChangeInStringParameterNamed(EmailCampaignValidator.emailSubject, this.emailSubject)) {
			final String newValue = command.stringValueOfParameterNamed(EmailCampaignValidator.emailSubject);
			actualChanges.put(EmailCampaignValidator.emailSubject, newValue);
			this.emailSubject = StringUtils.defaultIfEmpty(newValue, null);
		}
